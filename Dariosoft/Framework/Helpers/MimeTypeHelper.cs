namespace Dariosoft.Framework.Helpers
{
    public static class MimeTypeHelper
    {
        ...
        {
            return MimeTypeHelper.TryGetMimeType(str, out var result) && !string.IsNullOrWhiteSpace(result) ? result : DefaultMimeType;
        }
        ...
        {
            if (string.IsNullOrWhiteSpace(mimeType) || mimeType.StartsWith(Dot))
                return null;
